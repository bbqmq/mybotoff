...
# bot init
bot = Bot(token='5562424125:AAETx3eybA00CbATXqT6zCArybEGYAFj_ZA')
dp = Dispatcher(bot)
...
<a href="https://t.me/rave_admin">Разработчик</a>
...
ℹ️ | Чтобы купить Коины, обратитесь к владельцу бота @rave_admin
